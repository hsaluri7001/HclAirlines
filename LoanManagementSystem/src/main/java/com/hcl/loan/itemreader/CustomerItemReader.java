package com.hcl.loan.itemreader;
...
public class CustomerItemReader {
	public ItemReader<Customer> createUserItemReader() {
		...
		itemReader.setResource(new FileSystemResource("D://HCL CLEARANCE/HCLAccountTransactions.csv"));
	...
	private LineTokenizer createUserLineTokenizer() {
		...
		lineTokenizer.setNames(new String[] { "id", "userName", "gender", "age", "aadhar" });
